...
Web application front-end and public-facing website for Redback Project 2 (Wearables for the elderly).
...
1. Clone the repository to your local machine
    ```bash
    git clone https://github.com/Redback-Operations/redback-senior-web.git
    ```
